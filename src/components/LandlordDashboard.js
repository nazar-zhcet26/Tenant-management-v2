...
const LandlordDashboard = () => {
    ...
    const [landlordConfig, setLandlordConfig] = useState(null); // Subscription & maintenance_email
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            // Fetch landlord subscription info from landlords table
    ...
    const triggerWebhook = async (payload, actionType) => {
        ...
        if (landlordConfig.subscription_tier === 'premium') {
            ...
            // Basic landlord webhook (uses maintenance_email)
            webhookUrl =
                actionType === 'approve'
